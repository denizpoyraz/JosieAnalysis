...
def mainfunction(dff, simlistf, teamlistf, filef, category, boolpersim):
    ...
    for j in range(len(simlistf)):
        ...
        plot_eachrange(dft, r1_min, r1_max, time_r1_b, out1, title, 'R0')
...
df = pd.read_csv("/home/poyraden/Analysis/JOSIEfiles/Proccessed/Josie18_Data_current_conv.csv", low_memory=False)
...
# file.close()
#
file = open('2018_TimeResponse_Fit.txt', "w")
