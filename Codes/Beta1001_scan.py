...
from Analyse_Functions import cuts0910, cuts2017
...
df1 = pd.read_csv("/home/poyraden/Analysis/JOSIEfiles/Proccessed/Josie0910_deconv_beta0_1_tempfixed.csv", low_memory=False)
df2 = pd.read_csv("/home/poyraden/Analysis/JOSIEfiles/Proccessed/Josie0910_deconv_beta0_2_tempfixed.csv", low_memory=False)
df3 = pd.read_csv("/home/poyraden/Analysis/JOSIEfiles/Proccessed/Josie0910_deconv_beta0_3_tempfixed.csv", low_memory=False)
df4 = pd.read_csv("/home/poyraden/Analysis/JOSIEfiles/Proccessed/Josie0910_deconv_beta0_4_tempfixed.csv", low_memory=False)
df5 = pd.read_csv("/home/poyraden/Analysis/JOSIEfiles/Proccessed/Josie0910_deconv_beta0_5_tempfixed.csv", low_memory=False)
df6 = pd.read_csv("/home/poyraden/Analysis/JOSIEfiles/Proccessed/Josie0910_deconv_beta0_6_tempfixed.csv", low_memory=False)
# df6 = pd.read_csv("/home/poyraden/Analysis/JOSIEfiles/Proccessed/Josie0910_deconv_beta0_6test_tempfixed_paper.csv", low_memory=False)
...
profEN1010 = [ df1[filterEN1010_1], df2[filterEN1010_2], df3[filterEN1010_3], df4[filterEN1010_4],df5[filterEN1010_5], df6[filterEN1010_6]]

profSP0505 = [  df1[filterSP0505_1], df2[filterSP0505_2], df3[filterSP0505_3], df4[filterSP0505_4],df5[filterSP0505_5], df6[filterSP0505_6]]
profSP1010 = [  df1[filterSP1010_1], df2[filterSP1010_2], df3[filterSP1010_3], df4[filterSP1010_4],df5[filterSP1010_5], df6[filterSP1010_6]]
...
# errorPlot_ARDif_withtext(rdif_IM_deconv8, rdif_IM_deconv8_err, Yp, [-40, 40], [1000,5],  '2017 Data Conv-Deconv (Current Smoothed 8 secs)',
...
errorPlot_general(rdif_IM_deconv_en0505, rdif_IM_deconv_en0505_err, Yp, [-20, 20], [1000,5],  '0910 Data Conv-Deconv (Current - iB0 Smoothed 8 secs) ENSCI 0.5%-0.5',
                         rxtitlecur, ytitle,labellist_0505, colorlist, 'EN0505_smoothed8', folderpath, True, False, False)
...
errorPlot_general(rdif_IM_deconv_en1010, rdif_IM_deconv_en1010_err, Yp, [-20, 20], [1000,5],  '0910 Data Conv-Deconv (Current - iB0 Smoothed 8 secs) ENSCI 1.0%-1.0',
                         rxtitlecur, ytitle,labellist_1010, colorlist, 'EN1010_smoothed8', folderpath, True, False, False)
...
#                          rxtitlecur, ytitle,labellist_1001, colorlist, 'EN1001_smoothed8', folderpath, True, False, False)
...
errorPlot_general(rdif_IM_deconv_sp0505, rdif_IM_deconv_sp0505_err, Yp, [-20, 20], [1000,5],  '0910 Data Conv-Deconv (Current - iB0 Smoothed 8 secs) SP 0.5%-0.5',
                         rxtitlecur, ytitle,labellist_0505, colorlist, 'SP0505_smoothed8', folderpath, True, False, False)
...
#                          rxtitlecur, ytitle,labellist_1001, colorlist, 'SP01001_smoothed8', folderpath, True, False, False)
...
errorPlot_general(rdif_IM_deconv_sp1010, rdif_IM_deconv_sp1010_err, Yp, [-20, 20], [1000,5],  '0910 Data Conv-Deconv (Current - iB0 Smoothed 8 secs) SP 1.0%-1.0',
                         rxtitlecur, ytitle,labellist_1010, colorlist, 'SP1010_smoothed8', folderpath, True, False, False)
